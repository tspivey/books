...
Modify your config file in $HOME/.books.toml, setting up your matching regular expressions.
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.books.toml)")
